...
static const _TelemetryState_type_support_symbol_names_t _TelemetryState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, telemetry_bridge, msg, TelemetryState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, telemetry_bridge, msg, TelemetryState)),
  }
};
...
{
  return &::telemetry_bridge::msg::rosidl_typesupport_cpp::TelemetryState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, telemetry_bridge, msg, TelemetryState)() {
  return get_message_type_support_handle<telemetry_bridge::msg::TelemetryState>();
}
