...
bool telemetry_bridge__msg__telemetry_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("telemetry_bridge.msg._telemetry_state.TelemetryState", full_classname_dest, 52) == 0);
  }
  telemetry_bridge__msg__TelemetryState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TelemetryState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("telemetry_bridge.msg._telemetry_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TelemetryState");
